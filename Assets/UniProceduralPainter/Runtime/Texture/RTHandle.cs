...
namespace UniProceduralPainter
{
    public class RTHandle
    {
        ...
        public GraphicsFormat Format => m_RT.graphicsFormat;

        public bool EnableRandomWrite => m_RT.enableRandomWrite;

        public TextureDimension Dimension => m_RT.dimension;
        ...
        public RTHandle(int size, GraphicsFormat colorFormat, bool enableRandomWrite = false)
        {
            //cubemap
